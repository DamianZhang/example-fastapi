...
def test_get_all_posts_success(authorized_client, test_posts):
...
def test_create_post_success(authorized_client, test_user, test_posts, title, content, published):
...
def test_update_post_not_exist(authorized_client, test_user, test_posts):
    ...
    # # res.status_code will get 422, because pydantic will validate it
    # res = authorized_client.put(f"/posts/8000000")
